...
import org.scalalang.spores.typechecker.Analyzer

class Plugin(val global: Global) extends NscPlugin {
  import global._

  val name = "spores"
  val description = "Compiler support for spores"
  ...
  phasesDescMap(PluginComponent) = "sporification"
  ...
  // if (!getClass.getName.startsWith("org.scalalang.spores")) println(getClass.getName)
  //
