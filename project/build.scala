...
object build extends Build {
  lazy val sharedSettings = Defaults.defaultSettings ++ Seq(
    ...
    logBuffered := false,
    scalaHome := {
      val scalaHome = System.getProperty("spores.scala.home")
      if (scalaHome != null) {
  ...
  lazy val plugin = Project(
    ...
    resourceDirectory in Compile <<= baseDirectory(_ / "src" / "main" / "scala" / "org" / "scalalang" / "spores" / "embedded"),
    ...
    pomExtra := (
      ...
      <url>https://github.com/heathermiller/spores-plugin</url>
      ...
      <scm>
        <url>git://github.com/heathermiller/spores-plugin.git</url>
        <connection>scm:git:git://github.com/heathermiller/spores-plugin.git</connection>
      </scm>
      <issueManagement>
        <system>GitHub</system>
        <url>https://github.com/heathermiller/spores-plugin/issues</url>
      </issueManagement>
      <developers>
        <developer>
          <id>lamp</id>
  ...
  lazy val usePluginSettings = Seq(
    scalacOptions in Compile <++= (Keys.`package` in (plugin, Compile)) map { (jar: File) =>
      System.setProperty("spores.plugin.jar", jar.getAbsolutePath)
